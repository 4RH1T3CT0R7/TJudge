...
-- после чего её повторяют в окно низкой нагрузки. схема при этом остаётся
-- dirty=45: `./migrate force 44`, затем снова up (docs/OPERATIONS.md §9.7).
-- golang-migrate выполняет файл
