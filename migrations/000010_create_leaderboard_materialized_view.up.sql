...
-- Это кэшированный результат для быстрого получения leaderboard
...
-- Create materialized view for tournament-specific leaderboards
...
-- Create function to refresh leaderboards
