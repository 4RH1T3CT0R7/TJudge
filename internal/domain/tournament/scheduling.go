...
// SchedulingService manages match scheduling: round-robin generation, game-specific
// rounds, retry of failed matches, and on-demand scheduling for new programs.
